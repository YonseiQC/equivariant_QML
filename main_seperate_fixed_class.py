...
def train(gate_type, dataset, minibatch_size, epochs_q, epochs_c, key, init_scale, num_blocks_reupload, num_blocks_circuit, num_classes, **adam_opt):
    ...
    if gate_type == "u2":
        ...
        def Quantum_parameter_opt(train_dataset_x, train_dataset_y, test_dataset_x, test_dataset_y, batch_size, minibatch_size, params, opt_state_q):
        ...
        for cycle in range(2):
            params, opt_state_q = Quantum_parameter_opt(train_dataset_x, train_dataset_y, test_dataset_x, test_dataset_y, batch_size, minibatch_size, params, opt_state_q)
